...
private:
    ...
    int egzaminas;
public:
    Studentas() : egzaminas(0) { Zmogus::vardas = "", Zmogus::pavarde = ""; }

    Studentas(string vardas, string pavarde, vector<int> paz, int egz) : egzaminas(0) { vardas = vardas; pavarde = pavarde; };
